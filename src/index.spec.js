        ...
        expected: [
          {
            ...
            match_score: 3,
            normalized_text: 'any|text|content',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        expected: [
          ...
          },
          {
            ...
            description: 'User description $$$',
            match_score: 3,
            normalized_text: 'store|1',
            normalized_name: '',
            normalized_description: 'user|description|',
            baby: null,
          },
        ],
      },
      ...
      },
      {
        param: {
          ...
          options: [
            {
              id: 82030,
              name: 'Находка-241 Аутсорс (60)',
              address: 'Омская обл, Черлакский р-н, д Бердниково',
              count: 60,
            },
            {
              id: 82031,
              name: 'Находка-242 Аутсорс (63)',
              address: 'Омская обл, Черлакский р-н, д Бердниково, д. 205',
              count: 63,
            },
            {
              id: 82032,
              name: 'Находка-460 Аутсорс',
              address: 'Омская обл, Черлакский р-н, д Бердниково',
              count: 28,
            },
            {
              id: 65264,
              name: 'Находка-476 Аутсорс',
              address: 'Оренбургская обл, Сакмарский р-н, с Верхние Чебеньки, ул Салихова',
              count: 14,
            },
            {
              id: 70969,
              name: 'Находка-492 Аутсорс',
              address: '460050, Оренбургская область, г .Оренбург, проезд Нижний здание № 5/5',
              count: 14,
            },
            {
              id: 71437,
              name: 'Находка-495 Аутсорс',
              address: 'region: ОО; РР: Абусева Т.Р.; СВН: Кашапова Е.В.; СВ: Салихова О.Н.',
              count: 14,
            },
            {
              id: 19524,
              name: 'Табыш-324 Аутсорс',
              address: 'Респ Татарстан, г Нижнекамск, пр-кт Мира, д 460, помещ 1102',
              count: 12,
            },
          ],
          childrenField: 'children',
        ...
        expected: [
          {
            ...
            count: 60,
            match_score: 1,
            normalized_name: 'находка|241|аутсорс|60|',
            normalized_address: 'омская|обл|черлакский|р|н|д|бердниково',
          },
          {
            id: 82032,
            name: 'Находка-460 Аутсорс',
            ...
            count: 28,
            match_score: 2,
            normalized_name: 'находка|460|аутсорс',
            normalized_address: 'омская|обл|черлакский|р|н|д|бердниково',
          },
          {
            id: 70969,
            ...
            count: 14,
            match_score: 3,
            normalized_name: 'находка|492|аутсорс',
            normalized_address: '460050|оренбургская|область|г|оренбург|проезд|нижний|здание|5|5',
          },
          {
            id: 19524,
            name: 'Табыш-324 Аутсорс',
            ...
            count: 12,
            match_score: 2,
            normalized_name: 'табыш|324|аутсорс',
            normalized_address: 'респ|татарстан|г|нижнекамск|пр|кт|мира|д|460|помещ|1102',
          },
        ],
      },
    ];
